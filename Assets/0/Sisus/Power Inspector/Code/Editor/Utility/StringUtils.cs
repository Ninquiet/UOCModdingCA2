	...
	public static class StringUtils
	{
		...
		public static void ToString([NotNull]MethodInfo method, [NotNull]StringBuilder sb)
		{
			...
			else
			{
				...
				// Can help prevent crashes from Unity's internal methods like UnityEditor.PlayerSettings.InternalGetPlayerSettingsObject_Injected
				if(methodName.EndsWith("_Injected", StringComparison.Ordinal))
				{
					#if DEV_MODE && DEBUG_ENABLED
					Debug.LogWarning("Skipping " + method + "..."); // TEMP
					#endif
