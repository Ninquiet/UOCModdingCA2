...
namespace Sisus
{
	...
	public class SearchBoxToolbarItem : ToolbarItem, ISearchBoxToolbarItem
	{
		...
		protected override void OnGUI(Rect itemPosition, bool mouseovered)
        {
			...
			//string setFilter = EditorGUI.TextField(filterFieldDrawRect, rawFilterInput, EditorStyles.toolbarSearchField);
			//filterChanged = !string.Equals(setFilter, rawFilterInput);
			//#else
