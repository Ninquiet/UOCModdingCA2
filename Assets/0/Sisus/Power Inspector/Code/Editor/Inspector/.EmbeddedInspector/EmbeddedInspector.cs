...
{
	[Serializable]
	public sealed class EmbeddedInspector : Inspector<EmbeddedInspectorDrawer, PowerInspectorToolbar>
	{
		/// <inheritdoc/>
		...
		{
			return PowerInspector.GetPreferences();
		}
		...
		{
			return "EmbeddedInspector";
		}

		public EmbeddedInspector() { }
