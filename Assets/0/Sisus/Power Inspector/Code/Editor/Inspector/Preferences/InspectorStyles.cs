...
namespace Sisus
{
	public class InspectorStyles
	{
		...
		public InspectorStyles([NotNull]GUISkin skin)
		{
			...
			ToolbarCancel = skin.FindStyle("ToolbarSearchCancelButton") ?? skin.GetStyle("ToolbarSeachCancelButton");
			ToolbarCancelEmpty = skin.FindStyle("ToolbarSearchCancelButtonEmpty") ?? skin.GetStyle("ToolbarSeachCancelButtonEmpty");
			...
			FilterField = skin.FindStyle("ToolbarSearchTextField") ?? skin.GetStyle("ToolbarSeachTextField");
			FilterFieldWithDropdown = skin.FindStyle("ToolbarSearchTextFieldPopup") ?? skin.GetStyle("ToolbarSeachTextFieldPopup");
