...
namespace Sisus
{
	...
	public class DrawerProviderData
	{
		...
		public void Clear()
		{
			...
			drawersByAttributeType.Clear();
			propertyDrawerDrawersByFieldType.Clear();
			components.Clear();
			assets.Clear();
			assetsByExtension.Clear();
			propertyDrawerDrawersRequiringSerializedProperty.Clear();
			gameObjectByComponent.Clear();
			gameObject = null;
			gameObjectCategorized = null;
			componentDefault = null;
			customEditorComponentDefault = null;
			assetDefault = null;
			customEditorAssetDefault = null;
			classDefault = null;
		}
	}
}